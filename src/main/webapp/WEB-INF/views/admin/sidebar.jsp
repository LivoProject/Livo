...
<div class="g-sidenav-show bg-gray-200">
    <!-- Desktop Sidebar -->
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white d-none d-xl-block" id="sidenav-main">
        ...
        <div class="navbar-collapse w-auto max-height-vh-100 h-100 ps" id="sidebarMenu">
            <ul class="nav nav-pills flex-column mb-3">
                ...
                <li>
                    <a href="/admin/lecture" class="nav-link">
                        <i class="bi bi-people me-2"></i>강의 관리
                    </a>
                </li>
                <li>
                    <a href="/admin/report" class="nav-link">
                        <i class="bi bi-people me-2"></i>신고 처리
                    </a>
                </li>
                <li>
                    <a href="/admin/notice/list" class="nav-link">
                        <i class="bi bi-gear me-2"></i>공지사항 관리
                    </a>
                </li>
                <li>
                    <a href="/admin/faq" class="nav-link">
                        <i class="bi bi-gear me-2"></i>FAQ 관리
                    </a>
                </li>
            </ul>
        </div>
